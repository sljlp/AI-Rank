        ...
        for name, val in eval_res.items():
            ...
            if name == 'mIoU':
                ...
                for _ in range(dist.get_world_size()):
                    tList.append(torch.tensor(0.0).cuda())

                dist.all_gather(tensor_list=tList, tensor=torch.tensor(val).cuda(), async_op=False)
                if runner.rank == 0:
                ...
                try:
                    ...
                    TopVal = 78.5
                if runner.rank == 0 and name == 'mIoU' and val * 100 >= TopVal:
                    train_done = True
